corc <-
  function(dataframe,varnames,subsampsize,nbsafe=5)
  {
    ...
    cop=corc0( obs, nnm, dimension, subsampsize, nboot, u )
    ...
    return(list(cop=cop,ties=ties,nsubsampreal=nbootreel,
                varnames=varnames,nnm=nnm,
